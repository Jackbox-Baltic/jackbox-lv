...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("main/internal/ecast-test-client/assets/red.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="main/internal/ecast-test-client/assets/arrow.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
